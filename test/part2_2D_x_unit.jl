...
@testset "Height H between baseline and 2D xpu/mpi implementation of dam break in x-direction" begin
      H_mpi, xc = shallow_water_2D_xpu_mpi(; nx = n, ny = n, dam1D_x = true)
	@reset_parallel_stencil()
	H_xpu = shallow_water_2D_xpu(; nx = n, ny = n, dam1D_x = true)
	@reset_parallel_stencil()
